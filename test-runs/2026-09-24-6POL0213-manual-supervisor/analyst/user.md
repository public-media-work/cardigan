...
**Verified facts (computed from the source — never estimate these):** duration 18.1 minutes; transcript ~4825 words; project 6POL0213; source file 6POL0213.srt.
**Draft metadata guidance:** Draft title ≤ 80 chars; draft short description ≤ 90; draft long description ≤ 350; 15-20 keywords.
**Voice:** third person, descriptive. Never use: viewer directives (watch as, watch how, see how), promises (will show, will teach, will reveal), sales language (free), emotional predictions (what viewers can expect), unevidenced superlatives (amazing, incredible, extraordinary), calls to action (join us, don't miss, tune in), first-person promotional language (we break down, we analyze). No first-person (we, we'll, we've, our, us, I, my).
